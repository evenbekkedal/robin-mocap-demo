...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 359.0, 143.0, 20.0 ],
					"text" : "Read soundfile from disc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 474.5, 78.0, 20.0 ],
					"text" : "Sound on/off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 359.0, 95.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 206.0, 384.0, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.5, 445.0, 205.0, 65.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 36.5, 430.5, 19.0, 65.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 395.5, 85.0, 20.0 ],
					"text" : "loadmess 150"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 430.5, 25.0, 65.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.5, 257.0, 136.0, 20.0 ],
					"text" : "fFE.3D1 0.001 @filter 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 69.0, 474.5, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 513.5, 55.0, 19.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 215.5, 405.0, 191.0, 405.0, 191.0, 354.0, 176.5, 354.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 215.5, 378.0, 215.5, 378.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 110.5, 426.5, 21.5, 426.5 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				...
				"bootpath" : "/Users/evenbekkedal/Dropbox/Kode/Max/Even-max-patches/Robin Demonstrasjonmateriale 2013/iPod Demopatches/iPod SoundSaber & LoopPlayer",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
