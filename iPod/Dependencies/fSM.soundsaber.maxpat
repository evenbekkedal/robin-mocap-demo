...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 86.0, 181.0, 76.0 ],
					"presentation_rect" : [ 674.0, 190.0, 0.0, 0.0 ],
					"text" : "For best sound result:\nI/O Vector Size = 512\nSignal Vector Size = 64\nScheduler in Overdrive = 1\nin Audio Interrupt = 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 22.0, 302.0, 63.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 507.0, 48.0, 20.0 ],
					"text" : "volume"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 108.0, 106.0, 116.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 134.0, 161.0, 42.0, 20.0 ],
									"text" : "*~ 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 172.0, 74.0, 20.0 ],
									"text" : "tapout~ 150"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 136.0, 67.0, 20.0 ],
									"text" : "tapin~ 300"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 143.5, 190.0, 182.0, 190.0, 182.0, 126.0, 59.5, 126.0 ],
									"source" : [ "obj-37", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 59.5, 201.0, 129.0, 201.0, 129.0, 151.0, 143.5, 151.0 ],
									"source" : [ "obj-38", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 59.5, 80.0, 34.0, 80.0, 34.0, 231.0, 59.5, 231.0 ],
									"source" : [ "obj-42", 0 ]
								}
...
,
					"patching_rect" : [ 61.0, 478.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 696.0, 206.0, 98.0, 34.0 ],
					"text" : "turn on/off bass reduction"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 523.0, 125.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 367.0, 83.0, 20.0 ],
					"text" : "scaling"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 332.0, 83.0, 20.0 ],
					"text" : "scaling"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 401.0, 240.0, 83.0, 20.0 ],
					"text" : "clipping"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 594.0, 94.0, 20.0 ],
					"text" : "bass reduction"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 667.0, 280.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 274.0, 639.0, 80.0, 20.0 ],
					"text" : "selector~ 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 667.0, 206.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 335.0, 610.0, 318.0, 20.0 ],
					"text" : "biquad~ 0.996137 -1.965779 0.969989 -1.965663 0.966243"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 339.0, 269.0, 62.0, 20.0 ],
					"text" : "slide 5. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 339.0, 240.0, 55.0, 20.0 ],
					"text" : "clip 0. 2."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.0, 307.0, 54.0, 20.0 ],
					"text" : "filtering"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 133.0, 308.0, 62.0, 20.0 ],
					"text" : "slide 5. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 357.0, 48.0, 20.0 ],
					"text" : "scaling"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 274.0, 76.0, 20.0 ],
					"text" : "exponential"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 202.0, 118.0, 34.0 ],
					"text" : "limiting delta-values to 1 m/sample"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.0, 246.0, 119.0, 20.0 ],
					"text" : "converting to meters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 168.0, 195.0, 20.0 ],
					"text" : "z position controls filter frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.0, 127.0, 195.0, 20.0 ],
					"text" : "absolute velocity controls volume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 42.0, 181.0, 34.0 ],
					"text" : "Optimized for a qualisys rigid body, with sampling rate 100 Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 5.0, 161.0, 34.0 ],
					"text" : "input is based on data output from fFE.3D.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 52.0, 226.0, 21.0 ],
					"text" : "fourMs Sound Module - SoundSaber"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 14.0, 260.0, 42.0 ],
					"text" : "fSM.soundsaber"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 12.0, 263.0, 61.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 611.0, 205.0, 65.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 207.0, 55.0, 20.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.0, 461.0, 33.0, 18.0 ],
					"text" : "$1 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 479.0, 494.0, 48.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 339.0, 457.0, 33.0, 18.0 ],
					"text" : "$1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 339.0, 494.0, 48.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.0, 409.0, 92.0, 20.0 ],
					"text" : "scale 0. 4. 1. 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 339.0, 327.0, 32.5, 20.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 339.0, 409.0, 132.0, 20.0 ],
					"text" : "scale 0. 16. 50. 13000."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 339.0, 527.0, 159.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 305.0, 572.0, 192.5, 20.0 ],
					"text" : "biquad~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 607.0, 511.0, 107.0, 20.0 ],
									"text" : "bass tone"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 584.0, 572.0, 107.0, 20.0 ],
									"text" : "lowpass filter"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 135.0, 89.0, 374.0, 20.0 ],
									"text" : "vertical velocity and horizontal velocity controls one delay liine each"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 554.0, 391.0, 33.0, 18.0 ],
									"text" : "$1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 554.0, 439.0, 48.0, 20.0 ],
									"text" : "line~ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 424.0, 186.0, 72.0, 20.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 554.0, 185.0, 112.0, 20.0 ],
									"text" : "scale 0. 2. 40. 100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 537.0, 592.0, 170.0, 33.0 ],
									"text" : "biquad~ 0.001503 0.003006 0.001503 -1.917998 0.92401"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 537.0, 652.0, 42.0, 20.0 ],
									"text" : "*~ 23."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 554.0, 522.0, 42.0, 20.0 ],
									"text" : "*~ 0.6"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 554.0, 486.0, 62.0, 20.0 ],
									"text" : "cycle~ 30"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 537.0, 554.0, 36.0, 20.0 ],
									"text" : "*~ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 371.0, 455.0, 46.0, 20.0 ],
									"text" : "line~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 127.0, 148.0, 129.0, 20.0 ],
									"text" : "scale -0.1 0.1 20. 1.46"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 127.0, 176.0, 72.0, 20.0 ],
									"text" : "clip 1.46 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 127.0, 209.0, 34.0, 18.0 ],
									"text" : "$1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 454.0, 414.0, 42.0, 20.0 ],
									"text" : "*~ 0.8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 424.0, 487.0, 68.0, 20.0 ],
									"text" : "tapout~ 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "tapconnect" ],
									"patching_rect" : [ 424.0, 443.0, 60.0, 20.0 ],
									"text" : "tapin~ 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 268.0, 147.0, 119.0, 20.0 ],
									"text" : "scale 0. 0.1 20. 1.46"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 268.0, 176.0, 72.0, 20.0 ],
									"text" : "clip 1.46 20"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 268.0, 209.0, 34.0, 18.0 ],
									"text" : "$1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 361.0, 337.0, 46.0, 20.0 ],
									"text" : "line~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 473.0, 283.0, 42.0, 20.0 ],
									"text" : "*~ 0.9"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 424.0, 368.0, 68.0, 20.0 ],
									"text" : "tapout~ 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "tapconnect" ],
									"patching_rect" : [ 424.0, 315.0, 60.0, 20.0 ],
									"text" : "tapin~ 20"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 424.0, 207.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 424.0, 243.0, 51.0, 20.0 ],
									"text" : "metro 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 424.0, 274.0, 41.0, 20.0 ],
									"text" : "click~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 127.0, 745.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 127.0, 113.0, 231.0, 20.0 ],
									"text" : "OSC-route /delta_z /horizontal_velocity /z"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 433.5, 514.0, 503.0, 514.0, 503.0, 408.0, 463.5, 408.0 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 433.5, 532.5, 546.5, 532.5 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 433.5, 532.5, 136.5, 532.5 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 546.5, 682.0, 136.5, 682.0 ],
									"source" : [ "obj-55", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 546.5, 592.0, 546.5, 592.0 ],
									"source" : [ "obj-71", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 433.5, 397.0, 531.0, 397.0, 531.0, 279.0, 482.5, 279.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 433.5, 430.5, 136.5, 430.5 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 61.0, 406.0, 52.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"digest" : "",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 147.0, 333.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 133.0, 146.0, 179.0, 20.0 ],
					"text" : "OSC-route /absolute_velocity /z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 61.0, 437.0, 91.0, 20.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 133.0, 357.0, 32.5, 20.0 ],
					"text" : "* 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 380.0, 33.0, 18.0 ],
					"text" : "$1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 133.0, 405.0, 48.0, 20.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 96.0, 506.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 61.0, 533.0, 48.0, 20.0 ],
					"text" : "*~ 0.02"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 662.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 314.5, 600.5, 344.5, 600.5 ],
					"source" : [ "obj-138", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 348.5, 357.0, 362.0, 357.0 ],
					"source" : [ "obj-147", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 348.5, 357.5, 488.5, 357.5 ],
					"source" : [ "obj-147", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 142.5, 119.0, 70.5, 119.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 676.5, 705.0, 249.0, 705.0, 249.0, 623.0, 283.5, 623.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 70.5, 563.0, 314.5, 563.0 ],
					"source" : [ "obj-71", 0 ]
				}
